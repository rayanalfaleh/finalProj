...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.onSyn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    // check all data in the database on the server
                    TruncateServerTable();
                    // insert all data in the local database into the server
                    SyncData();
    ...
    private void TruncateServerTable() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("http://192.168.8.102:80/sqli/mysql_truncate.php");
